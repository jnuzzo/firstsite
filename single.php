...
<div class="container pt-5">
	...
	<p>he attendees gathered at the Nuzzo home to meet and greet each other and then marched to the fort behind a bagpiper and re-enactors of the 77th Scots Highlanders, where a dedication ceremony was held to unveil a storyboard about the fort and a boulder-mounted brass plaque for Clan Maclean. Speeches were given by Sir Lachlan Maclean, Ian Maclean of the Maclean Clan Heritage Trust and Peter Folen of the Folmont Property Owners Association.</p>

	<p>After the event the guests re-assembled for a reception and luncheon.  Historic artifacts from Fort Duart, Miller's Tavern and other sites along the Forbes Road were displayed by the Somerset County Historical Society.  Larry Andrews, the artist who created an original painting of the building of Fort Duart as displayed on the storyboard, was also there to offer prints of his work.  Bill Nuzzo gave a brief talk about the history of the Forbes Road after the war and then presented a hand-made commemorative plate of the event to Sir Lachlan to be lodged at Castle Duart in Scotland. A duplicate plate will remain at Fort Duart. Below are pictures of the plate and explanatory parchment.  The embedded coin is a Silver Shilling minted in 1758.</p>

	<h2 class="text-center mt-5">Fort Duart Commemorative Plate (#1 of 2)</h2>
	<h6 class="text-center mb-3">To Return to Castle Duart</h6>
	<img src="assets/img/maclean1.jpg" class="img-fluid mb-5" alt="maclean clan family photo">

	<p>This plate of native cherry and walnut was made by William L. Nuzzo and presented to Sir
	...
	work on the fort. He went on to a distinguished military career.  He died December 10, 1783.</p>

	<h2 class="text-center mt-5">Sir Allan MacLean of Brolas</h2>
	<h6 class="text-center mb-3">22nd Clan Chief</h6>
	<img src="assets/img/maclean2.jpg" class="img-fluid mb-5 mx-auto d-block" alt="maclean clan family photo">

	<p>After the war Fort Duart languished in the wilderness while countless American pioneers
	passed by on their way to Pittsburgh, often stopping at the nearby Miller’s Tavern.  The
	...
	dig was made at Fort Duart and Miller’s Tavern.  Many artifacts were unearthed.  In 1972
	...
	began the process of adding Fort Duart to the National List of Historic Places.</p>
